...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#fefcf1]">
      <div className="w-full max-w-md space-y-6">
        ...
        {state?.success ? (
          <Card className="border-[#e6dfcb] shadow-lg p-8 text-center space-y-4">
            <div className="h-14 w-14 rounded-full bg-[#e8f5e9] text-[#2e7d32] mx-auto flex items-center justify-center">
              <CheckCircle2 className="h-8 w-8" />
            </div>
            <h2 className="font-serif text-xl font-bold text-[#2c3324]">
