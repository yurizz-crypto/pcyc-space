    ...
    <div className="flex flex-col w-full">
      ...
      <div className="w-full bg-[#fbf1e2] dark:bg-[#2b2315] border-b border-[#e0a861]/40 text-[#422e1b] dark:text-[#f0be7c] py-3 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left text-xs sm:text-sm">
          <div className="flex items-center gap-2.5">
            ...
            <span>
              <strong className="text-[#2c3324] dark:text-[#fefcf1]">Testing Phase Notice:</strong> Merchandise catalog is currently in preview mode. Ordering and checkout are temporarily disabled during platform testing.
            </span>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-[#fefcf1] dark:bg-[#131710]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <div className="p-6 rounded-2xl bg-[#f8f4e3] dark:bg-[#1b2117] border border-[#e6dfcb] dark:border-[#323d2b] flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              <div className="h-10 w-10 rounded-xl bg-[#2c3324] text-[#e0a861] flex items-center justify-center shrink-0">
                <QrCode className="h-5 w-5" />
              </div>
              <div className="space-y-1">
                <h4 className="font-serif font-bold text-base sm:text-lg text-[#2c3324] dark:text-[#fefcf1]">
                  Zero-Fee Direct Community Payment
                </h4>
                <p className="text-xs sm:text-sm text-[#707666] dark:text-[#a3ab98] max-w-2xl">
                  To keep our merchandise prices low and completely fee-free, orders are paid directly via{' '}
                  <strong className="text-[#2c3324] dark:text-[#fefcf1]">GCash (0912-734-1648, Yuri S.)</strong>. Simply upload
                  your receipt screenshot upon ordering once checkout goes live.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 text-xs font-semibold text-[#9a6423] dark:text-[#f0be7c] bg-[#fbf1e2] dark:bg-[#2b2315] px-3.5 py-2 rounded-xl border border-[#e0a861]/30 whitespace-nowrap">
